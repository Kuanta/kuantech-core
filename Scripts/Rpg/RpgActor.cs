...
{
    public class RpgActor : MonoBehaviour //todo: The inheritance replicates code. Refactor here
    {
        [Header("Properties")] 
        ...
        private Dictionary<Type, RpgActorModule> _modules = new Dictionary<Type, RpgActorModule>();
        ...
        public virtual void Initialize()
        {
            ...
            RpgActorModule[] modules = GetComponents<RpgActorModule>();
            foreach (RpgActorModule module in modules)
            {
        ...
        public RpgActorModule GetModuleByType(Type moduleType)
        {
        ...
        public virtual float ReceiveDamage(RpgActor from, float damage, bool rawDamage = false)
        {
            ...
            if (!rawDamage)
            {
                ...
                damage *= (1 - Mathf.Exp(-damage/(armorValue*RpgConfig.ARMOR_COEFF)));
            }
        ...
        public virtual float ReceivePercentageDamage(RpgActor from, float damage, bool rawDamage = false)
        {
