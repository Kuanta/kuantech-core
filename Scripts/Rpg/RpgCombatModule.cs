...
namespace Kuantech.Rpg
{
    ...
    public class RpgCombatModule : ActorModule
    {
        // //Components
        ...
        //     return !IsAttacking && GlobalCooldown.IsOffCooldown() && !AttackLock.IsLocked() && Actor.IsAlive() ;
        // }
        //
        ...
        // {
        //     AnimationModule animMod = (AnimationModule)Actor.GetModuleByType(typeof(AnimationModule));
        //
        ...
        //     return false;
        // }
        // public List<RpgActor> GetCircularAreaEnemies(Vector3 center, float range, bool checkObstacle, float angle = 0f)
        // {
        //     List<RpgActor> attackables = new List<RpgActor>();
        ...
        //         RpgActor target = results[i].GetComponent<RpgActor>();
        ...
        //     }
        // }
        // public List<RpgActor> GetLinearAreaEnemies(float range, float width, bool checkObstacle)
        // {
        //     List<RpgActor> attackables = new List<RpgActor>();
        ...
        //     }
        //
        //     RpgActor target = CurrentAttackPattern.TargetedProjectile ? CurrentTarget : null;
        ...
        //     RpgActor actor = hitInfo.collider.gameObject.GetComponent<RpgActor>();
        ...
        // /// <param name="target"></param>
        // public void OnProjectileImpact(Projectile projectile, RpgActor target)
        // {
        //     if (CanUseSkill)
        //     {
        ...
        // #endregion
        //
        // public void DamageActorMelee(RpgActor target, float damage, float knockback, float knockbackTime)
        // {
        ...
        // }
        //
        // public float GetMomentum(RpgActor target)
        // {
        //     //Calculate momentum 
        //     float momentum = 0;
        //
