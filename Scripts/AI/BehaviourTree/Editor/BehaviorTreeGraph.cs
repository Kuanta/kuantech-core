...
namespace Kuantech.Editor
{
    ...
    public class BehaviorTreeGraphView : GraphView
    {
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            evt.menu.AppendAction("Add Child Graph", (action) => CreateSubTreeAtPosition("SubTree", mousePosition));
        ...
        public BtGraphNode CreateSubTreeAtPosition(string name, Vector2 position)
        {
            var node = new BTSubTreeNode(this);
            node.NodeName = name;
            AddElement(node);
        ...
        private BtGraphNode ParseGraphNodeData(BtGraphNodeData data, BtGraphNode parentNode, int connectionIndex)
        {
            ...
            }else if(data.NodeType == BTNode.NodeTypes.SUB_GRAPH)
            {
                node = new BTSubTreeNode(this);
            }
            else
            {
